...
static const yytype_uint16 yyrline[] =
{
     ...
     127,   128,   131,   132,   135,   136,   139,   149,   150,   153,
     ...
     394,   401,   404,   405,   408,   409,   412,   413,   416,   417,
     420,   423,   426,   427,   430,   431,   432,   435,   436,   439,
     440,   443,   444,   447,   448,   451,   452,   455,   456,   459,
     462,   463,   466,   467,   470,   471,   474,   475,   476,   477,
     478,   479,   480,   481,   484,   489,   496,   497,   500,   501,
     504,   505,   508,   509,   512,   513,   516,   517,   520,   521,
     524,   527,   528,   531,   532,   535,   536,   539,   540,   543,
     544,   547,   552,   560,   565,   573,   574,   577,   578,   581,
     582,   585,   586,   589,   590,   593,   595,   598,   599,   602,
     603,   606,   607,   610,   611,   645,   646,   647,   648,   649,
     650,   651,   652,   653,   654,   655,   658,   663,   670,   671,
     674,   675,   678,   679,   682,   683,   686,   687,   702,   703,
     706,   711,   735,   737,   739,   741,   745,   758,   765,   766,
     767,   770,   780,   798,   799,   802,   808,   810,   812,   814,
     820,   825,   830,   833,   834,   837,   838,   841,   842,   845,
     846,   849,   850,   853,   854,   857,   858,   861,   862,   865,
     871,   872,   875,   876,   879,   880,   883,   884,   885,   888,
     889,   892,   893,   896,   897,   900,   901,   904,   905,   908,
     913,   928,   929,   932,   933,   936,   937,   940,   941,   944,
     945,   948,   949,   952,   958,   959,   962,   963,   966,   967,
     970,   971,   972,   975,   976,   979,   980,   983,   984,   987,
     988,   991,   992,   995,   996,   999,  1000,  1003,  1004,  1007,
    1008,  1011,  1012,  1015,  1016
};
#endif
...
#line 3022 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 249:
#line 866 "includes/parse.y" /* yacc.c:1646  */
    {
...
#line 3053 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 270:
#line 914 "includes/parse.y" /* yacc.c:1646  */
    {
            (yyval.node) = (yyvsp[-1].node);
...
#line 3070 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 279:
#line 944 "includes/parse.y" /* yacc.c:1646  */
    { delete [] (yyvsp[-5].identifier); }
#line 3076 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 280:
#line 945 "includes/parse.y" /* yacc.c:1646  */
...
#line 3090 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 311:
#line 1011 "includes/parse.y" /* yacc.c:1646  */
...
#line 1019 "includes/parse.y" /* yacc.c:1906  */
