...
int saturate(const int & x, const int & l, const int & h);
...
color_t color_scalar(const float & k, const color_t & c);

color_t color_plus(const color_t & c1, const color_t & c2);

color_t color_minus(const color_t & c1, const color_t & c2);
